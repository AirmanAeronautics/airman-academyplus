-- Add debug logging and RAISE NOTICE to see exactly what happens
...
BEGIN
  ...
  IF FOUND THEN
    RAISE NOTICE 'DEBUG: Domain match found, org_id=%, auto_approve=%', matching_org_id, org_settings_record.auto_approve_domain;
