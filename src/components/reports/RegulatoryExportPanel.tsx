...
export const RegulatoryExportPanel = () => {
  ...
  // TODO: wire aviation_region from backend profile once API is ready
  // For now, fallback to DGCA as default (backend User type doesn't include aviation_region yet)
  // Get user's regulatory authority based on aviation region
  const userAuthority = 'DGCA'; // Fallback default - will be replaced when backend profile API includes aviation_region
